...
public class FirestoreReadService {
    ...
    private DeliveryResponse toDeliveryResponse(Map<String, Object> data) {
        ...
        return new DeliveryResponse(
                asLong(data.get("id")),
                asLong(data.get("orderId")),
                trackingNumber,
                asLong(data.get("branchId")),
                asString(data.get("branch")),
                asString(data.get("branchAddress")),
                asString(data.get("customerName")),
                asString(data.get("customerPhone")),
                asString(data.get("deliveryAddress")),
                asString(data.get("driverName")),
                asLong(data.get("assignedDriverId")),
                asString(data.get("driverPhone")),
                asString(data.get("driverPhotoUrl")),
                asString(data.get("driverVehicle")),
                asString(data.get("paymentMethod")),
                asString(data.get("paymentStatus")),
                asBoolean(data.get("isPaid")),
                asBigDecimal(data.get("amountToCollect")),
                asBigDecimal(data.get("loadKg")),
                asLong(data.get("loadCount")) != null ? asLong(data.get("loadCount")).intValue() : null,
