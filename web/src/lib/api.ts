...
export type JobOrderResponse = {
  ...
  extraWeightCost?: number | null;
  detergentBreakdown?: string | null;
  fabricConditionerBreakdown?: string | null;
  detergentQuantity?: number | null;
  conditionerQuantity?: number | null;
