      ...
      {featureDetails.map((f, i) => (
        <div key={f.id}>
          ...
          <div className="grid grid-cols-2">
            <img src={`https://picsum.photos/seed/feat${f.id}a/800/600`} alt={f.title} className="w-full h-[200px] md:h-[300px] object-cover" />
            <img src={`https://picsum.photos/seed/feat${f.id}b/800/600`} alt={f.title} className="w-full h-[200px] md:h-[300px] object-cover" />
            <img src={`https://picsum.photos/seed/feat${f.id}c/800/600`} alt={f.title} className="w-full h-[200px] md:h-[300px] object-cover" />
            <img src={`https://picsum.photos/seed/feat${f.id}d/800/600`} alt={f.title} className="w-full h-[200px] md:h-[300px] object-cover" />
          </div>
        </div>
      ))}
